...
public class JwtConfig {
  ...
  private static RSAKey parse(String pem) {
    try {
      ...
      throw new IllegalStateException("twitterclone.jwt.signing-key is not a usable RSA PEM", e);
    }
  }
  ...
  private static RSAKey ephemeral() {
    LOG.warn(
        "No twitterclone.jwt.signing-key configured; generating an ephemeral RSA key. "
