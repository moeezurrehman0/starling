...
@SpringBootTest(
    ...
    properties = {
      ...
      "twitterclone.dynamodb.endpoint=http://localhost:1",
      ...
      "twitterclone.fanout.enabled=false"
    })
...
class FanoutWorkerApplicationTest {
  ...
  @SpringBootTest(
      ...
      properties = {
        "twitterclone.dynamodb.endpoint=http://localhost:1",
        "twitterclone.fanout.enabled=true"
      })
  ...
  class Consuming {
    ...
    @MockitoBean private dev.twitterclone.fanout.domain.FanoutRunner runner;
